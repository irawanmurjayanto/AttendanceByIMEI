...
public class AdapterActivity extends RecyclerView.Adapter<BarangAdapterCurency.BarangViewHolder> {


    List<BarangDialog> barangs;
    Context mContext;
    public AdapterActivity(List<BarangDialog> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_dialog_currency, viewGroup,false);
    ...
    public BarangDialog getItem(int position) {
    ...
    public static class BarangViewHolder extends RecyclerView.ViewHolder {
        ...
        BarangViewHolder(View itemView) {
            ...
            barangItemcode = (TextView) itemView.findViewById(R.id.textBarcode);
