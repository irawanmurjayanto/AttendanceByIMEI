...
pDialog=new ProgressDialog(this);
        ...
        butnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // Toast.makeText(getBaseContext(),"nilai : "+checkin2.tglin2+"-"+checkin1.jamin1+"-"+checkin1.pilin1,Toast.LENGTH_LONG).show();
                ...
                Intent intent11 = new Intent("checkin1");
                sendBroadcast(intent11);
                Intent intent12 = new Intent("checkin2");
                sendBroadcast(intent12);
                Intent intent13 = new Intent("checkin3");
                sendBroadcast(intent13);
                Intent intent14 = new Intent("checkintanya");
    ...
    private void savecheckin3(){
        ...
        String url = AppConfig.IP_SERVER+"andro/savecheckin1.php";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
...

            {
                ...
                //checkin1
                params.put("tgl1",checkin1.tglin1);
                params.put("jam1",checkin1.jamin1);
                params.put("nilai1",checkin1.pilin1);

                //checkin2
                params.put("tgl2",checkin2.tglin2);
                params.put("jam2",checkin2.jamin2);
                params.put("nilai2",checkin2.pilin2);

                //checkin3
                params.put("tgl3",checkin3.tglin3);
                params.put("jam3",checkin3.jamin3);
                params.put("nilai3",checkin3.pilin3);
