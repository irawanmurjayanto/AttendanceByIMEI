...
public class checkin4 extends AppCompatActivity {
    ...
    private Context context = checkin4.this;
...
dialogform(barang.getIDNO());
    ...
    private void delaktivitas(final int idno){
    ...
    public void onErrorResponse33(VolleyError error) {
        if (error instanceof NetworkError) {
            //DialogErrorNetwork();
        } else if (error instanceof ServerError) {
            //DialogErrorServer();
    ...
    private void processResponse33(String response){
...
//                finish();
 ...
 loaddatavolley();
    ...
    private void dialogform(final int idno) {
        dialog = new AlertDialog.Builder(this);



        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.reg_warning2, null);
